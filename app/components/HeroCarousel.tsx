            ...
            >
                ...
                <SwiperSlide>
                    <div className="w-full h-full bg-gradient-to-r from-blue-50 to-white relative flex items-center">
                        ...
                        <div className="relative z-20 w-full px-8 md:px-16 flex items-center justify-between">
                            <div className="max-w-2xl space-y-6">
                                <div className="inline-block px-4 py-1.5 rounded-full bg-blue-600 text-white text-sm font-bold tracking-wide shadow-sm">
                                ...
                                <p className="text-gray-600 text-lg md:text-xl font-medium">
                                    Reach thousands of customers islandwide. Join the fastest growing marketplace today and start boosting your sales.
                                </p>
                                <div className="pt-4 w-full flex gap-4">
                                    <Link href="/become-a-seller" className="inline-block px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all active:scale-95 text-center">
                                        Start Selling Now
                                    </Link>
                                    <Link href="#latest-arrivals" className="inline-block px-8 py-4 bg-white border border-gray-200 hover:bg-gray-50 text-gray-900 font-bold rounded-xl shadow-sm hover:shadow-md transition-all active:scale-95 text-center">
                                        Shop Products
                                    </Link>
                                </div>
                            </div>
                    ...
                    <div className="w-full h-full bg-gradient-to-r from-gray-100 to-white relative flex items-center">
                        <div className="relative z-20 w-full px-8 md:px-16">
                            <div className="max-w-xl space-y-6">
                                <div className="inline-block px-4 py-1.5 rounded-full bg-gray-900 text-white text-sm font-bold tracking-wide">
                                ...
                                <p className="text-gray-600 text-lg md:text-xl font-medium">
                                    100% Genuine, Warranty Covered, and Easy Returns. Find the best tech and lifestyle products.
                                </p>
                                <div className="pt-4">
                                    <Link href="#latest-arrivals" className="inline-block px-8 py-4 bg-gray-900 hover:bg-black text-white font-bold rounded-xl shadow-lg transition-all active:scale-95 text-center">
                                        Explore Arrivals
                                    </Link>
                                </div>
                            </div>
